...
print("Computing first atmosphere to save into a file - could go straight to memory.")
j.run('1:10:1', save_alpha='file')
print("Get into memory (you don't need to do file first - this is just for demo)")
